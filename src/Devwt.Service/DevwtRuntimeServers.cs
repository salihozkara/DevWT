            ...
            <body>
                      ...
                      <form id="add-repository-form" class="admin-form" onsubmit="addRepository(event)">
                        <div class="form-grid two">
                          <label>Repository or worktree path
                            <input id="repository-path" autocomplete="off" placeholder="D:\repos\my-app" required>
                          </label>
                      ...
                      <form id="link-map-form" class="admin-form" onsubmit="addLinkMap(event)">
                        <div class="form-grid">
                          <label>Linked repository name
                            <input id="link-map-repository" autocomplete="off" placeholder="shared-lib" required>
                          </label>
                          ...
                          <label>Target worktree
                            <input id="link-map-target" autocomplete="off" placeholder="D:\worktrees\feature\shared-lib" required>
                          </label>
                        </div>
                  ...
                  <dialog id="context-description-dialog">
                    ...
                    <form class="dialog-form" onsubmit="saveContextDescription(event)">
                      ...
                      <label>Short task label
                        <textarea id="context-dialog-description" maxlength="160" placeholder="Review gateway routing" required></textarea>
                      </label>
              ...
              <script>
                ...
                function addLinkedRepositoryInput() {
                  ...
                  row.innerHTML = `
                    <label>Name
                      <input class="linked-repository-name" autocomplete="off" placeholder="shared-lib" required>
                    </label>
                    <label>Repository path
                      <input class="linked-repository-path" autocomplete="off" placeholder="D:\\repos\\shared-lib" required>
                    </label>
