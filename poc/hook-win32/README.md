...
This is an isolated proof of concept for user-mode localhost bind rewriting.
...
This proves the force-folder process-observation shape, but the fallback polling
path is not race-free for processes that bind immediately after process
