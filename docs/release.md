...
DevWT preview releases ship a zip installer bundle. The hook-core line does not include a custom DevWT kernel driver and does not require Windows TESTSIGNING.
...
```txt
private\installer\DevWT-installer.zip
```
...
gh release create v0.1.0-preview.3 private\installer\DevWT-v0.1.0-preview.3-installer.zip --title "DevWT v0.1.0-preview.3" --prerelease --notes-file RELEASE_NOTES.md
```
