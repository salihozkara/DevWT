...
public sealed class DevwtCliRunnerTests
{
    ...
    {
        var client = new RecordingControlClient(new DevwtCommandResult("created repo volo\n", 0));
        ...
        Assert.Equal("created repo volo\n", result.Output);
        var request = Assert.Single(client.Requests);
        Assert.Equal(DevwtControlOperation.AddRepository, request.Operation);
        Assert.Equal(@"C:\repos\volo", request.AddRepository!.WorkingDirectory);
        Assert.Equal("abp", Assert.Single(request.AddRepository.LinkedRepositories).Name);
    }
    ...
    public void Pause_resume_remove_hook_and_link_map_are_sent_to_control_client()
    {
        ...
        DevwtCliRunner.Execute(["pause", "--repo", "volo"], @"C:\repos\volo", client);
        DevwtCliRunner.Execute(["resume", "--worktree", "."], @"C:\repos\volo", client);
        DevwtCliRunner.Execute(["remove"], @"C:\repos\volo", client);
        DevwtCliRunner.Execute(["hook", "worktree-ready", "--repo-id", "repo-volo", "--path", "."], @"C:\work\volo", client);
        DevwtCliRunner.Execute(["link", "map", "--linked-repo", "abp", "--source", ".", "--target", "../abp"], @"C:\work\volo", client);
        ...
        Assert.Collection(
            ...
            request =>
            {
                ...
                Assert.Equal(@"C:\repos\volo", request.WorktreePath);
            },
    ...
    public void Context_description_is_sent_as_an_idempotent_worktree_update()
    {
        ...
        Assert.Collection(
            ...
            request =>
            {
                ...
                Assert.Equal(@"C:\work\volo", request.WorktreePath);
                Assert.Equal("Review driver code", request.ContextDescription);
    ...
    public void Port_commands_send_context_aware_queries()
    {
        ...
        Assert.Collection(
            ...
            request =>
            {
                ...
                Assert.Equal(@"C:\work\volo\src", request.PortQuery.WorkingDirectory);
            ...
            request =>
            {
                ...
                Assert.Equal(44334, request.PortQuery!.Port);
                Assert.Equal(@"C:\work\volo", request.PortQuery.WorkingDirectory);
    ...
    public void Remove_by_repo_does_not_send_current_directory()
    {
        ...
        DevwtCliRunner.Execute(["remove", "--repo", "volo"], @"C:\repos\other", client);

        var request = Assert.Single(client.Requests);
        Assert.Equal(DevwtControlOperation.RemoveRepository, request.Operation);
        Assert.Equal("volo", request.RepositoryName);
    ...
    public void Proxy_target_and_clear_are_sent_to_control_client()
    {
        ...
        DevwtCliRunner.Execute(
            ...
            @"C:\repos\volo",
            client);
        DevwtCliRunner.Execute(["proxy", "clear"], @"C:\repos\volo", client);
        ...
        Assert.Collection(
            ...
            request =>
            {
                ...
                Assert.Equal("ctx-volo", request.ActiveTarget!.ContextId);
    ...
    public void Proxy_global_context_and_port_clear_are_sent_to_control_client()
    {
        ...
        DevwtCliRunner.Execute(
            ["proxy", "context", "--context", "ctx-volo"],
            @"C:\repos\volo",
            client);
        DevwtCliRunner.Execute(
        ...
        Assert.Collection(
            ...
            request =>
            {
                ...
                Assert.Equal("ctx-volo", request.GlobalActiveContextId);
            },
            request =>
            {
                Assert.Equal(DevwtControlOperation.SetActiveTarget, request.Operation);
    ...
    public void Proxy_process_target_and_clear_are_sent_to_control_client()
    {
        ...
        Assert.Collection(
            ...
            request =>
            {
                ...
                Assert.Equal("ctx-volo", request.ProcessTarget.ContextId);
            },
            request =>
            {
                Assert.Equal(DevwtControlOperation.SetProcessTarget, request.Operation);
    ...
    public void Proxy_child_stop_and_kill_are_sent_to_control_client()
    {
        ...
        Assert.Collection(
            ...
            request =>
            {
                ...
                Assert.Equal("ctx-volo", request.ProxyChildTarget!.ContextId);
    ...
    public void Sandboxie_commands_return_help_without_control_request()
    {
        ...
        var result = DevwtCliRunner.Execute(["sandboxie", "status"], @"C:\repos\volo", client);
